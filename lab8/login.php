...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($row['password'] === $password) {
            ...
            //sai mk
            echo "sai mật khẩu. Vui long thử lại";
        }
    }else{
        echo "người dung không tồn tại";
    }
    //đóng kết nối
    mysqli_close($conn);
}
...
<body>
    <div class="container">
        <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post">
            ...
            <input type="submit" value="login" name="btn-regis" id="btn-regis"><br><br>
            <div id="message_line1" class="message"><?php echo $message; ?>
