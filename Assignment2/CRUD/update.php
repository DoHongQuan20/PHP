...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE sanpham2 SET name = '$name' ,description =' $description ', price ='$price' WHERE id = '$id'";
    ...
    $query = "SELECT * FROM sanpham2 WHERE id= '$id'";
    $result = mysqli_query($conn, $query);
...
<body>
    <div class="container my-5">
        ...
        <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST">
            ...
            <input type="file" name="fileToUpload" id="fileToUpload" value="<?php echo $img; ?>"><br>
